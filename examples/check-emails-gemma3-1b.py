...
# Initialize the model with Ollama using Gemma 1B
llm = ChatOllama(
    model='gemma3:1b',  # Use the smaller 1B model
    host='http://localhost:11434',
    keep_alive='30m',
    options={
        'temperature': 0.7,
        'top_p': 0.9,
        'num_ctx': 4096,      # Smaller context window for 1B model
        'num_thread': 4,      # Fewer threads for lighter model
...
agent = Agent(
    ...
    # Configure timeouts
    llm_timeout=120,  # Shorter timeout for faster model
    step_timeout=180,
